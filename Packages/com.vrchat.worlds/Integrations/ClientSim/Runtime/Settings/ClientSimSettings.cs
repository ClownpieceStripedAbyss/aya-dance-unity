...
namespace VRC.SDK3.ClientSim
{
    public class ClientSimSettings
    {
        ...
        public readonly string[] availableLanguages = { 
            "English", "French", "German", "Italian", "Japanese", "Korean", "Spanish", "Portuguese", "Brazilian", 
            "Hebrew", "Polish", "Toki Pona", "Indonesian", "Chinese Simplified", "Chinese Traditional", "Russian" };
